...
export default function PictureWorkbench({
  ...
  // --- keys --------------------------------------------------------------------
  const keyState = useRef({ draft, picture, tell, crop, tab, factsOn, setFactsOn, selectedLayer, painting });
  keyState.current = { draft, picture, tell, crop, tab, factsOn, setFactsOn, selectedLayer, painting };
  useEffect(() => {
