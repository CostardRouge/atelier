    ...
    return (
      ...
      >
        <div className="max-w-[48ch] text-center">
          <p className="m-0 mb-3 font-mono text-2xs uppercase tracking-[0.2em] text-accent-ink">
          ...
          <p className="m-0 mb-5 text-ink-soft text-base leading-[1.6]">
          ...
          {error.message && (
            <pre className="m-0 mb-5 px-4 py-3 text-left overflow-auto rounded-paper border border-line bg-surface font-mono text-xs leading-[1.5] text-ink-soft">
              {error.message}
            </pre>
          )}
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            <button
              ...
              className="inline-flex items-center px-4 py-2 rounded-paper border border-line text-sm font-semibold text-muted transition-colors duration-200 ease-paper hover:text-accent hover:border-accent"
            >
              Reload
            </button>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center text-sm font-semibold text-accent-ink underline underline-offset-[3px] hover:text-accent"
            >
              Report
            </a>
          </div>
