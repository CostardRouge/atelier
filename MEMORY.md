...
- Both editor stages zoom the VIEW through one shared primitive, applied as LAYOUT size inside a scroll box (never a transform); ⌘/ctrl-wheel and a two-finger pinch, while a bare wheel keeps whatever the stage already used it for — `frontend.md`.
